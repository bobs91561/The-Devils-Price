	...
	public class CompassNavigatorProInspector : Editor {
		...
		public override void OnInspectorGUI () {
			...
			if (expandCompassPOISettings) {
				_compass.visibleDistance = EditorGUILayout.Slider (new GUIContent ("Visible Distance", "POIs beyond visible distance (meters) will not be shown in the compass bar."), _compass.visibleDistance, 10, 10000);
