Shader "NatureManufacture Shaders/Lava/Lava River Tesseled Vertex Color"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v )
		{
			...
			float2 panner611 = ( _Time.y * temp_output_731_0 + uv_ColdLavaAlbedo_SM);
			...
			float2 panner598 = ( _Time.y * (( (float)Direction723 == 1.0 ) ? _MediumLavaMainSpeed :  appendResult710 ) + uv_MediumLavaAlbedo_SM);
			...
			float2 panner606 = ( _Time.y * (( (float)Direction723 == 1.0 ) ? _HotLavaMainSpeed :  appendResult712 ) + uv_HotLavaAlbedo_SM);
