...
--------------------------------------------------
Volumetric cloud probes require Unity 2018.3 or newer for async GPU readbacks to avoid GPU stalls. Earlier versions of Unity may suffer from FPS loss due to GPU stalling.
