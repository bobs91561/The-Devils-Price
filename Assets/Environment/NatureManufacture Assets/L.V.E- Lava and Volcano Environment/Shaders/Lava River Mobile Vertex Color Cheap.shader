Shader "NatureManufacture Shaders/Lava/Lava River Mobile Vertex Color Cheap"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 panner598 = ( _Time.y * (( (float)Direction723 == 1.0 ) ? _MediumLavaMainSpeed :  appendResult710 ) + uv_ColdLavaAlbedo_SM);
			...
			float2 panner606 = ( _Time.y * (( (float)Direction723 == 1.0 ) ? _HotLavaMainSpeed :  appendResult712 ) + uv_ColdLavaAlbedo_SM);
